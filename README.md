...
<!-- Row 1: Stats + Languages — vercel hosted, most reliable -->
<div align="center">

<img height="195em"
     src="https://github-readme-stats.vercel.app/api?username=rnrahate&show_icons=true&include_all_commits=true&count_private=true&hide_border=true&bg_color=0d1117&title_color=3fb950&icon_color=2ea043&text_color=8b949e&ring_color=2ea043"
     alt="Aryan's GitHub Stats" />
&nbsp;&nbsp;
<img height="195em"
     src="https://github-readme-stats.vercel.app/api/top-langs/?username=rnrahate&layout=compact&langs_count=8&hide_border=true&bg_color=0d1117&title_color=3fb950&text_color=8b949e"
     alt="Top Languages" />

</div>

<!-- Row 2: Streak — using git.io/streak-stats (more stable than herokuapp) -->
<div align="center">
...
<!-- Row 3: Contribution snake — generated by GitHub Action (setup below) -->
## 🟩 Contribution Graph
...
<details>
<summary>⚙️ &nbsp;<strong>One-time setup to activate the snake — click to expand <code>snake.yml</code></strong></summary>

<br/>

Create `.github/workflows/snake.yml` inside your `rnrahate/rnrahate` profile repo.  
It reads your **real green dot contribution grid** and auto-regenerates every 24 hours.
...
1. Commit and push `snake.yml` to your `main` branch
2. Go to **Actions** tab → select **Generate Contribution Snake** → click **Run workflow**
3. Once complete, an `output` branch appears with the SVG files
4. The snake will now render live in your README 🐍
...
<!-- githubprofiletrophies.vercel.app — more stable than the herokuapp variant -->
<div align="center">

<img src="https://github-profile-trophy.vercel.app/?username=rnrahate&theme=matrix&no-frame=true&no-bg=true&column=6&margin-w=10&margin-h=10"
     alt="GitHub Trophies" />
